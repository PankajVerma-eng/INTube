...
const PlayVideo = () => {
  ...
  const fetchVideoData = async () =>{
    // fetching video data with the help of the videoId
  ...
  return ( 
    ...
    <div className='play-video-info'>
     <p>{apiData?value_converter(apiData.statistics.viewCount):"viewCount(16k)"} Views &bull; {apiData?moment(apiData.snippet.publishedAt).fromNow():"2 days ago"}</p>
     <div>
    ...
    <hr/>
      ...
      <p>{apiData?apiData.snippet.description.slice(0,300):"i hope you like my video "}</p>
      <hr/>
